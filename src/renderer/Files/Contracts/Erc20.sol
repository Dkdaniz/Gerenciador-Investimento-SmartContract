...
contract erc20Exemplecoin is StandardToken {
    using SafeMath for uint256;

    //Information coin
    string public name = "erc20Exemplecoin";
    string public symbol = "erc20Exemple";
    uint256 public decimals = 18;
    uint256 public totalSupply = 2000000000 * (10 ** decimals); //2 000 000 000 erc20Exemple
    ...
    uint256 public rate = 10000;             //erc20Exemple/ETH rate
...
// =================================== Constructor =============================================
    ...
    constructor() public {         
      walletETH = 0xb7748f37F215ac49Cc5C1b19249B46fADdb40b2F;
      tokenSale = 0xf5098E08db3E2D57426f1ee02d0AC0e43F596a40;                 //50%     
      bounty = 0x3A830158ED278CE14B9E09974400ada386F8E922;                    //15%
      awardsReservations = 0x0B765030055cE08D4c264aA134EcBb90d4e7912A;        //23% 
